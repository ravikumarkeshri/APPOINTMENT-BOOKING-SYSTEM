            ...
            <div className=" md:col-span-2 md:px-[30px]">
              <div>
                <button
                  ...
                  className={`p-2 px-5 mr-5 rounded-md text-headingColor border border-solid border-primaryColor font-semibold text-[16px] leading-7 ${tab === "bookings" && "bg-primaryColor text-white"
                    }`}
                >
                  My Booking
                </button>
                <button
                  ...
                  className={` py-2 px-5 rounded-md text-headingColor border border-solid border-primaryColor font-semibold text-[16px] leading-7  ${tab === "settings" && "bg-primaryColor text-white"
                    }`}
                >
                  Profile Settings
                </button>
